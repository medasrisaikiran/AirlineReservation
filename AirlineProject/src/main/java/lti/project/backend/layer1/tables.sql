...
drop table flightavailability cascade constraints;
...
username VARCHAR2(20) constraint u_username unique,
...
Saturday VARCHAR(2),
Sunday VARCHAR(2),
constraint fk_flight_id_2 foreign key(flightid) references FlightDetails(FlightId)
);
